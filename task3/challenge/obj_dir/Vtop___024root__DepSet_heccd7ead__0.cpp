...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (((((((((0U == vlSelf->top__DOT__f1Fsm__DOT__current_state) 
        ...
        if ((0U == vlSelf->top__DOT__f1Fsm__DOT__current_state)) {
            vlSelf->top__DOT__f1Fsm__DOT__next_state = 1U;
            vlSelf->data_out = 0U;
        } else if ((1U == vlSelf->top__DOT__f1Fsm__DOT__current_state)) {
        ...
        vlSelf->data_out = ((8U == vlSelf->top__DOT__f1Fsm__DOT__current_state)
                             ? 0xffU : 0U);
    }
